(function() {
  ...
  MainCtrl.$inject = ['$scope', 'Auth', '$state', '$modal', '$alert', '$timeout', '$http', 'looksAPI', 'scrapeAPI', 'Upload', '$location'];

  function MainCtrl($scope, Auth, $state, $modal, $alert, $timeout, $http, looksAPI, scrapeAPI, Upload, $location) {
